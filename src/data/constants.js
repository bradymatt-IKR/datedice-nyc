...
export const FILTERS_MAIN = {
  ...
  vibe: { label: "Vibe", icon: "✨", options: ["Romantic","Adventurous","Chill","Fancy","Quirky","Cozy","Lively","Intimate","Cultural","Artsy"], multi: true },
  budget: { label: "Budget", icon: "💰", options: ["Free","Under $50","$50–150","$150–300","Splurge ($300+)"] },
...
export const LOADING_MESSAGES = [
  ...
  "Bribing the ma\u00EEtre d' for the good stuff...",
  ...
  "Asking the pigeons \u2014 they know everything...",
...
export const FILTER_PRESETS = [
  ...
  { label: "Rainy Day Indoor", emoji: "🌧", filters: { category: "Activities", vibe: ["Cozy","Chill"], weather: "Rainy" } },
  { label: "Cheap Thrills", emoji: "🤑", filters: { category: "Surprise Me", vibe: ["Adventurous"], budget: "Under $50" } },
  { label: "Fancy Night Out", emoji: "🥂", filters: { category: "Food & Drink", vibe: ["Fancy","Intimate"], budget: "$150–300", timeOfDay: "Evening" } },
];
